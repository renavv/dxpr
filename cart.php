...
<head>
    ...
    <title>
        DX-Pro : Information Delivery Order Tel-U
    </title>
    ...
    <div class="container">
        <div class="navbar-header">
               ...
               <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    ...
                    <img src="logo.png" class="visible-xs"><span class="sr-only">DX-Pro - go to homepage</span>
                </a>
                <div class="navbar-buttons">
                    ...
                    <a class="btn btn-default navbar-toggle" href="cart.php">
                        <i class="fa fa-shopping-cart"></i>  <span class="hidden-xs"> Keranjang Pesanan </span>
                    </a>
                </div>
            </div>
            <!--/.navbar-header -->
